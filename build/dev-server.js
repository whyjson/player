...
var app = express();
var appData = require("../music-data.json");
var musicData = appData.musicData;
...
apiRoutes.get('/hot', (req, res) => {
  let hotKeywords = ['告白气球', '动物世界', '李荣浩', '变形金刚', '欧美金曲', '其实都没有', '跨界歌王', '就这样', '张杰', '赵雷', '李健', '林志炫', '张碧晨', '徐佳莹', '周笔畅', '张靓颖', '陈奕迅', '周杰伦', '王力宏', 'TFBoys', '李玉刚', '轻音乐', '薛之谦'];
